...
export default async function PrivacyPolicyRoute({
  ...
  const content = {
    ...
    principles: {
      ...
      items: t("privacy.principles.items", {
        returnObjects: true,
        defaultValue: [],
      }) as string[],
    },
    dataWeCollect: {
      ...
      table: {
        headers: t("privacy.dataWeCollect.table.headers", {
          returnObjects: true,
          defaultValue: [],
        }) as string[],
        rows: t("privacy.dataWeCollect.table.rows", {
          returnObjects: true,
          defaultValue: [],
        }) as string[][],
      },
      ...
      <section className="max-w-4xl mx-auto px-6 pb-12">
        <div className="rounded-2xl p-8 text-center text-white bg-gradient-to-b from-primary to-primary/90">
          ...
          <div className="space-y-4 opacity-90">
            <p className="rtl:text-lg rtl:font-medium">
